---
title: 法务页面与合规
description: 在管理后台维护服务条款、隐私政策与合规内容。
---
...
该页面注册为 `App\Filament\Admin\Pages\LegalPagesSettings`，在后台导航中归类于 **Settings**。访问受 `update settings` 权限与 `ConfigService::isAdminSettingsEnabled()` 控制。
